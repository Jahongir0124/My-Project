...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">{{ Auth::user()->teacher->full_name}}</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    {{ Auth::user()->teacher->full_name}}
                    <small>Fakultet: {{ Auth::user()->teacher->departament->name}}</small>
                    <small>Mutaxasisligi: {{ Auth::user()->teacher->specialization}}</small>
                  </p>
                </li>
                <!--end::User Image-->
                <!--begin::Menu Body-->
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="#" class="text-decoration-none">Admin | Dashboard</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
    ...
    <script src="/admin-assests/adminlte.js">
    </script>
