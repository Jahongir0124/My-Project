            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                {{-- <span class="d-none d-md-inline">{{ Auth::user()->student->first_name }} {{Auth::user()->student->last_name}}</span> --}}
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  <p>
                    ...
                    <small>Guruh {{ Auth::user()->student->group->name}}</small>
                    <small>Qo'shilgan vaqt {{ Auth::user()->student->created_at}}</small>
                  </p>
                </li>
                <!--end::User Image-->
                <!--begin::Menu Body-->
