                  ...
                  <div class="card-body">
                      ...
                      <tbody>
                        @foreach ($courses as $course)
                          ...
                          <td class="text-center"><a href="{{ route('teacher.subject.lessons', ['course' => $course]) }}" class="btn btn-primary mb-2 " >{{ $course->attendances->count()}}</a></td>
                          <td class="text-center"><a href="{{ route('teacher.attendance.create', ['course' => $course]) }}" class="btn btn-primary mb-2 " ><i class="bi bi-plus-lg"></i></a></td>
