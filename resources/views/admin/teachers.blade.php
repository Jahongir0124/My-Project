...
@section('title', 'Admin | O\'qituvchilar')
@section('content')
      ...
      <form action="{{ route('admin.teacher.store') }}" method="POST">
              ...
              <div class="modal-body">
                ...
                @enderror
                  ...
                  <div class="col-md-6">
                        <label for="validationCustom04" class="form-label">{{ __("Fakultet") }}</label>
                   ...
                   <div class="col-md-6">
                      <label>{{ __("Mutaxasisligi") }}</label>
                      <input  type="text" name="specialization" class="form-control" >
                  </div>
                  <div class="col-md-6">
                      <label>{{ __("Telefon nomeri") }}</label>
                    ...
                    <table class="table table-bordered">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th style="width: 25%" class="text-center">{{ __("To'liq ismi") }}</th>
                          <th style="width: 20%" class="text-center">{{ __("Fakulteti") }}</th>
                          <th style="width: 20%" class="text-center">{{ __("Mutaxasisligi") }}</th>
                          <th style="width: 20%" class="text-center">{{ __("Telefon nomeri") }}</th>
                      ...
                      <tbody>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">{{ $teacher->departament->name}}</td>
                          <td class="text-center">{{ $teacher->specialization}}</td>
                          <td class="text-center">{{ $teacher->phone}}</td>
                         
                          
                          <td class="text-center">
                            <button id="editGroupBtn" data-bs-toggle="modal" data-id="{{ $teacher->id }}" data-fname="{{ $teacher->first_name }}" data-lname="{{ $teacher->last_name }}" data-phone="{{ $teacher->phone }}"data-bs-target="#updateGroupModal"   class="btn btn-primary mb-2"><i class="bi bi-pen"></i></button>
                            </td>  
                          <td class="text-center">
                            <form action="{{ route('admin.teacher.destroy', ['id' => $teacher->id]) }}" method='POST' 
                              onsubmit="return confirm('{{ $teacher->full_name }} удалить?')">
                              @csrf
